...
export class UiContainer extends Phaser.GameObjects.Container {
     ...
     */
     maxBetInit() {
        ...
        this.maxbetBtn = this.createButton('maxBetBtn', gameConfig.scale.width / 2 - this.maxbetBtn.width / 1.3, gameConfig.scale.height - this.maxbetBtn.height - 18, () => {
    ...
    lineBtnInit() { 
        ...
        this.pBtn = this.createButton('pBtn', 35, 15, () => {
            this.bnuttonMusic("buttonpressed");
        ...
        this.mBtn = this.createButton('mBtn', -135, 15, () => {
            this.bnuttonMusic("buttonpressed");
        ...
        this.CurrentLineText = new TextLabel(this.scene, -50, 15, initData.gameData.Bets[currentGameData.currentBetIndex], 27, "#dab47b").setOrigin(0.5);
        //Line Count
    ...
    balanceBtnInit() {
        ...
        this.currentBalanceText = new TextLabel(this.scene, 0, 15, currentGameData.currentBalance.toFixed(2), 27, "#dab47b");
...
/**
    ...
    spinBtnInit(spinCallBack: () => void) {
        ...
        this.spinBtn = this.createButton('spinBtn', gameConfig.scale.width / 2, gameConfig.scale.height - this.spinBtn.height/1.35, () => {
     ...
     */
    BetBtnInit() {
        const container = this.scene.add.container(gameConfig.scale.width / 3.2, this.maxbetBtn.y);
        ...
        this.CurrentBetText = new TextLabel(this.scene, 0, 7, ((initData.gameData.Bets[currentGameData.currentBetIndex]) * 20).toString(), 27, "#dab47b").setDepth(6);
